<div>
    <div class="modal fade @if ($show === true) show @endif" id="myExampleModal"
        style="display: @if ($show === true) block @else none @endif;" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">{{ $data['name'] }}</div>
                <div class="modal-body">{{ $data['email'] }}</div>
                <div class="modal-body">{{ $data['phone_number'] }}</div>
